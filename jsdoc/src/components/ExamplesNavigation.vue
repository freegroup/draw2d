<template>
  <v-navigation-drawer app clipped permanent class="nav-sidebar">
    ...
    <div class="search-container">
      ...
      <input type="text" placeholder="Search examples..." v-model="searchText" class="filter-field">
    </div>
    <v-treeview
      :items="treeItems"
      :search="searchText"
...
export default {
  ...
  computed: {
    treeItems () {
      return this.convertTree(this.$router.options.examples)
    }
  },
  methods: {
