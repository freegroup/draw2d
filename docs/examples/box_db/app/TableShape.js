/**
 * TableShape - Database table visualization using Gen2 Box Layout
 * 
 * Uses draw2d.shape.box.VBox for vertical layout with deferred layout system.
 */
TableShape = draw2d.shape.box.VBox.extend({
    ...
    /**
     * Remove the entity with the given index from the DB table shape.
